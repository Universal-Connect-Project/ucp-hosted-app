...
export default defineConfig({
  env: {
    ...
    E2E_USERNAME_WITH_KEY_ROLES: process.env.E2E_USERNAME_WITH_KEY_ROLES,
    E2E_PASSWORD: process.env.E2E_PASSWORD,
    E2E_USERNAME_WITHOUT_KEY_ROLES: process.env.E2E_USERNAME_WITHOUT_KEY_ROLES,
    E2E_PASSWORD_WITHOUT_KEY_ROLES: process.env.E2E_PASSWORD_WITHOUT_KEY_ROLES,
  },
  e2e: {
